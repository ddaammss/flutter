...
class BookingApi {
  ...
  // ✅ Map으로 반환 타입 변경
  Future<Map<String, dynamic>> fetctBookingDetailData({Map<String, dynamic>? requestBody}) async {
    try {
      final response = await _apiService.post('/app/api/reservation', body: requestBody);
